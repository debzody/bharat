...
(function () {
    ...
    .chat-avatar i { color: #fff; font-size: 1.2rem; }
    .chat-agent-info { flex: 1; }
    .chat-agent-name { color: #fff; font-weight: 700; font-size: 0.95rem; }
    .chat-agent-status { color: rgba(255,255,255,0.82); font-size: 0.75rem; margin-top: 1px; }
    .chat-close-btn {
